  ...
  <div class="p-4 sm:p-6 lg:p-8 w-full">
    ...
    <template v-else>
      ...
      <div class="bg-surface-card border border-border rounded-2xl overflow-hidden">
        <!-- Header row -->
        <div class="hidden sm:grid grid-cols-[40px_0.4fr_0.6fr_0.8fr_0.8fr_0.6fr_0.6fr_0.7fr_0.6fr_auto] gap-3 px-5 py-3 border-b border-border bg-white/[0.02]">
        ...
        <div
          ...
          :key="invoice.id"
          class="grid grid-cols-1 sm:grid-cols-[40px_0.4fr_0.6fr_0.8fr_0.8fr_0.6fr_0.6fr_0.7fr_0.6fr_auto] gap-2 sm:gap-3 px-5 py-3.5 border-b border-border last:border-0 hover:bg-white/[0.02] transition-colors"
        >
          <span class="flex items-center">
