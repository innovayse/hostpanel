...
/**
 * Service Addons — manage add-on services attached to client accounts.
 */
</script>
...
<template>
  <div class="w-full">
    ...
    <div class="mt-6 bg-surface-card border border-border rounded-2xl flex flex-col items-center justify-center py-16 gap-3">
      ...
      <p class="text-[0.75rem] text-text-muted">Service addons management will be available here</p>
    </div>
  </div>
</template>
