...
/// <summary>
/// Command to create a new client account from the admin panel.
/// Supports both creating a new Identity user and linking to an existing one.
/// </summary>
...
public record AdminCreateClientCommand(
    bool CreateNewUser,
