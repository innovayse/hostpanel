...
/// Stored in the <c>client_transactions</c> table.
/// </summary>
public sealed class ClientTransaction : Entity
{
    ...
    private ClientTransaction() : base(0) { }

    /// <summary>
    /// Creates a new client transaction with the specified details.
    /// </summary>
    ...
    /// <returns>A new <see cref="ClientTransaction"/>.</returns>
