...
public interface IClientTransactionRepository
{
    ...
    Task<(IReadOnlyList<ClientTransaction> Items, int TotalCount)> ListByClientAsync(
    ...
    /// <summary>
    /// Adds a new client transaction to the repository.
    ...
    /// <summary>
    /// Removes a client transaction from the repository.
