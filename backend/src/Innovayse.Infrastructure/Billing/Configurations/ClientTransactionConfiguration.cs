...
/// <summary>EF Core configuration for the <see cref="ClientTransaction"/> entity.</summary>
public sealed class ClientTransactionConfiguration : IEntityTypeConfiguration<ClientTransaction>
{
    /// <summary>Configures the <c>client_transactions</c> table mapping.</summary>
    /// <param name="builder">The entity type builder.</param>
    public void Configure(EntityTypeBuilder<ClientTransaction> builder)
    {
        builder.ToTable("client_transactions");
