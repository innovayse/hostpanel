...
namespace Innovayse.Infrastructure.Migrations
{
    ...
    [Migration("20260607173251_AddManagedSiteTouchestateFields")]
    partial class AddManagedSiteTouchestateFields
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Innovayse.Domain.Products.Product", b =>
                {
                    ...
                    b.Property<string>("DeployRepoUrl")
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)");

                    b.Property<string>("DeployScript")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Innovayse.Domain.Services.ClientService", b =>
                {
                    ...
                    b.Property<string>("TouchEstatePublicKey")
                        .HasMaxLength(200)
                        .HasColumnType("character varying(200)");

                    b.Property<string>("TouchEstateSecretKey")
                        .HasMaxLength(200)
                        .HasColumnType("character varying(200)");
