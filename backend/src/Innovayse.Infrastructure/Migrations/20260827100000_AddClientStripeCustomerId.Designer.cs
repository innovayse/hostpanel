...
namespace Innovayse.Infrastructure.Migrations
{
    ...
    [Migration("20260827100000_AddClientStripeCustomerId")]
    partial class AddClientStripeCustomerId
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Innovayse.Domain.Audit.ActivityLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Innovayse.Domain.Auth.SubjectRole", b =>
                {
            ...
            modelBuilder.Entity("Innovayse.Domain.Billing.Transaction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Innovayse.Domain.Clients.Invitation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Innovayse.Domain.Domains.Domain", b =>
                {
                    ...
                    b.Property<bool>("DnsManagement")
                        .HasColumnType("boolean");

                    b.Property<bool>("EmailForwarding")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("Innovayse.Domain.Domains.DomainReminder", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("domain_reminders", (string)null);
                });

            modelBuilder.Entity("Innovayse.Domain.Domains.EmailForwardingRule", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("email_forwarding_rules", (string)null);
                });
            ...
            modelBuilder.Entity("Innovayse.Domain.Migration.MigrationJob", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Innovayse.Domain.Migration.MigrationLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Innovayse.Domain.Products.ProductFeature", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Innovayse.Domain.Slides.Slide", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Innovayse.Domain.Slides.SlideTranslation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("slide_translations", (string)null);
                });
            ...
            modelBuilder.Entity("Innovayse.Domain.Support.Download", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<bool>("ProductDownload")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("Innovayse.Domain.Support.DownloadCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("download_categories", (string)null);
                });
            ...
            modelBuilder.Entity("Innovayse.Domain.Support.KbCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Innovayse.Domain.Support.NetworkIssue", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("network_issues", (string)null);
                });

            modelBuilder.Entity("Innovayse.Domain.Support.PredefinedReply", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("predefined_replies", (string)null);
                });

            modelBuilder.Entity("Innovayse.Domain.Support.PredefinedReplyCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("predefined_reply_categories", (string)null);
                });
            ...
            modelBuilder.Entity("Innovayse.Domain.Slides.SlideTranslation", b =>
                {
                    b.HasOne("Innovayse.Domain.Slides.Slide", null)
            ...
            modelBuilder.Entity("Innovayse.Domain.Support.Download", b =>
                {
                    b.HasOne("Innovayse.Domain.Support.DownloadCategory", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Innovayse.Domain.Domains.Domain", b =>
                {
                    ...
                    b.Navigation("EmailForwardingRules");
