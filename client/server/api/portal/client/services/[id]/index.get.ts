...
export default defineEventHandler(async (event) => {
  ...
  return {
    ...
    username: s.username ?? (s.productType === 'ManagedSiteTouchestate' ? '' : 'provisioned'),
    password: '',
    subscriptionid: '',
    promoid: 0,
    ...
    touchEstatePublicKey: s.touchEstatePublicKey ?? '',
    touchEstateSecretKey: s.touchEstateSecretKey ?? '',
